...
Luno.prototype.listAccountPendingTransactions = function (id, callback) {
  let params = {}
  return this._request('GET', `/api/1/accounts/${id}/pending`, params, callback)
}
...
Luno.prototype.listAccountBalances = function (assets = [], callback) {
  let params = assets.length > 0 ? { assets } : {}
...
Luno.prototype._postMarketOrder = function (volume, type, options, callback) {
  let params = { type }
  let cb = callback
  if (typeof options === 'function') {
    cb = options
  ...
  if (!options.base_account_id && this.base_account_id) {
    params.base_account_id = this.base_account_id
  }

  if (!options.counter_account_id && this.counter_account_id) {
    params.counter_account_id = this.counter_account_id
  }

  return this._request('POST', '/api/1/marketorder', params, callback)
}

Luno.prototype.postMarketBuyOrder = function (volume, options, callback) {
  return this._postMarketOrder(volume, 'BUY', options, callback)
}

Luno.prototype.postMarketSellOrder = function (volume, options, callback) {
  return this._postMarketOrder(volume, 'SELL', options, callback)
}
